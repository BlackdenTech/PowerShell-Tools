# https://pmckibbins.wordpress.com/2013/01/21/powershell-text-to-speech/
function Speak-Text {
    param(
...
$phrases = @(
    ...
    'Youre in trouble Program. Why dont you make it easy on yourself? Whos your User?',
    'Autobots, Roll out',
    'My friends call me Murphy. You call me, Robocop.',
    'Bender is Great! Bender is great! Bender is great!',
    'We can rebuild him. We have the technology.',
    'Go Go Gadget copter!',
    'You hear that Mr. Anderson? Thats the sound of inevitability.',
